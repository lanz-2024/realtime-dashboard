...
export type WorkerInboundMessage = ProcessBatchMessage | ComputePercentilesMessage;
...
export type WorkerOutboundMessage = MovingAverageResult | PercentilesResult | WorkerErrorMessage;
