...
export function DashboardGrid({ latest, cpuSeries, memSeries, reqSeries }: Props) {
  if (!latest) {
    return (
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 bg-gray-900 rounded-xl p-5 border border-gray-800">
          <h3 className="text-gray-400 text-sm font-medium mb-4">CPU History</h3>
          <TimeSeriesChart
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-gray-900 rounded-xl p-5 border border-gray-800">
          <h3 className="text-gray-400 text-sm font-medium mb-4">Memory History</h3>
          <TimeSeriesChart
        ...
        <div className="bg-gray-900 rounded-xl p-5 border border-gray-800">
          <h3 className="text-gray-400 text-sm font-medium mb-4">Request Rate</h3>
          <TimeSeriesChart
